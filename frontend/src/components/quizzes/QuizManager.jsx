      ...
      >
        <form onSubmit={handleGenerateQuiz} className="space-y-4">
          <div>
            ...
            <input
              className="w-full h-9 px-3 border border-neutral-200 rounded-lg bg-white text-sm text-neutral-900 placeholder-neutral-400 transition-colors duration-150 focus:outline-0 focus:ring-2 focus:ring-[#00d492] focus:border-transparent"
              disabled={generating}
              type="number"
              value={numQuestions}
              onChange={(e) =>
