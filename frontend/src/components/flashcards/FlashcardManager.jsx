      ...
      return (
        <div className="flex flex-col items-center justify-center py-16 px-6">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100 mb-6">
            <Brain strokeWidth={2} className="w-8 h-8 text-emerald-600" />
          </div>
      ...
      >
        <div className="space-y-6">
          <p className="text-sm text-slate-600">
            Are you want to delete this flashcard set? This action cannot be
