  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 mb-8">
        <div className="inline-flex items-center gap-2 px-4 bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl mb-6">
          ...
          {currentQuestion.options.map((option, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Custom Radio Button */}
                <div
                  className={`shrink-0 w-5 h-5 border-2 rounded-full transition-all duration-200 ${isSelected ? "bg-emerald-500 border-emerald-500" : "bg-white border-slate-300 group-hover:border-emerald-400"}`}
                >
                  {isSelected && (
                ...
                {/* Option Text */}
                <span
                  className={`ml-4 text-sm font-medium transform-colors duration-200 ${isSelected ? "text-emerald-900" : "text-slate-700 group-hover:text-slate-900"}`}
                >
                  {option}
                </span>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {currentQuestionIndex === quiz.questions.length - 1 ? (
          ...
          >
            ...
            <div className="inset-0 absolute bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
          </button>
        ) : (
